...
def decision_from_score(score: pd.Series, buy_threshold: float = 70, sell_threshold: float = 30) -> pd.Series:
    """
...
def run_multi_strategy_analysis(df: pd.DataFrame, 
    ...
    decisions = decision_from_score(combined_score, buy_threshold, sell_threshold)
